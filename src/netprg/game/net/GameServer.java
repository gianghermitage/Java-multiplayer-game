...
public class GameServer extends Thread {
    ...
    private void parsePacket(byte[] data, InetAddress address, int port) {
        ...
        case LOGIN:
            ...
            PlayerMP player = new PlayerMP(game.level, 100, 100, ((Packet00Login) packet).getUsername(),((Packet00Login) packet).getColour(), address, port);
        ...
        case MINIONSPAWN:
        	...
        	Minion minion = new Minion(game.level, ObjectID.Minion, ((Packet03MinionSpawn)packet).getMinionID(),
        			((Packet03MinionSpawn)packet).getMinionX(), ((Packet03MinionSpawn)packet).getMinionY(), ((Packet03MinionSpawn)packet).getMinionSpeed());
        ...
        case BULLETSPAWN:
        	...
        	Bullet bullet = new Bullet(game.level, ObjectID.Bullet, ((Packet10BulletSpawn)packet).getBulletID(),((Packet10BulletSpawn)packet).getBulletColour(),
        			((Packet10BulletSpawn)packet).getBulletX(), ((Packet10BulletSpawn)packet).getBulletY(), 1);
        ...
        for (int i = 0; i < connectedPlayers.size();i++) {
            ...
            if (player.getUsername().equalsIgnoreCase(p.getUsername())) {
                ...
                for (int j = 0; j < minionList.size();j++) {
            		...
            		Packet03MinionSpawn minionPacket = new Packet03MinionSpawn(tempMinion.getMinionID(), tempMinion.getX(), tempMinion.getY(),tempMinion.getMinionSpeed());
                ...
                for (int j = 0; j < bulletList.size();j++) {
            		...
            		Packet10BulletSpawn bulletPacket = new Packet10BulletSpawn(tempBullet.getBulletID(), tempBullet.getX(), tempBullet.getY(),tempBullet.getBulletColourString());
