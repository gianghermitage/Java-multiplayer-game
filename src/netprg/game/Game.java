...
public class Game extends Canvas implements Runnable {
    ...
    public void init() {
    	...
    	player = new PlayerMP(level, 80, 250, input, JOptionPane.showInputDialog(this, "Please enter a username"), JOptionPane.showInputDialog(this, "Choose your color (w, r, g, b)"), null,-1);
        level.addEntity(player);

        
        if (!isApplet) {
            Packet00Login loginPacket = new Packet00Login(player.getUsername(), player.x, player.y,player.getColourString());
